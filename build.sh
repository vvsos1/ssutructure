...
browserify src/linear-probing/sketch.js -do output/js/linear-probing/sketch.js  # linear probing 페이지에 들어갈 js 번들링
# mkdir output/js/linear-probing
# cp src/linear-probing/* output/js/linear-probing
